...
const ExponentCalculator = () => {
  ...
  const calculateExponent = async () => {
    ...
    try {
      ...
      setResult("Failed to fetch result. Make sure the backend is running.");
    }
  };
    ...
    <BasicLayout>
      <div className="w-full max-w-sm mr-60 bg-white rounded-lg shadow-md p-3 sm:p-4">
        ...
        <p className="mb-2 text-gray-600 text-xs">
          Calculate exponents (powers) of numbers.
        </p>
          ...
          {result !== null && (
            <div className="mt-6 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <p className="text-gray-600">Exponent Value</p>
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="w-full max-w-md bg-white rounded-lg p-6">
            <Dialog.Title className="text-xl font-bold">
              Exponent Calculator Help
            </Dialog.Title>
            <Dialog.Description className="mt-4 text-gray-600">
              This calculator helps you compute exponents:
              <ul className="list-disc pl-5 mt-2 space-y-1">
                <li>Enter the base number</li>
                <li>Enter the exponent (power)</li>
                <li>Get the result of base raised to the power</li>
              </ul>
