...
const LogCalculator = () => {
  ...
  return (
    <BasicLayout>
      <div className="p-4 w-96 max-w-md mx-auto rounded-lg shadow-md mr-48  bg-white">
        <h1 className="text-2xl text-gray-800 font-bold mb-4">Logarithm Calculator
        <button
        ...
        <div className="mb-4">
          <label className="block mb-1 text-gray-800">Number</label>
          <input
            type="number"
            placeholder="e.g. 100"
        ...
        <div className="mb-4">
          <label className="block mb-1 text-gray-800">Base (use 'e' for natural log)</label>
          <input
            type="text"
      ...
      <div className="p-4 w-96 max-w-md mx-auto rounded-lg mr-48 text-gray-800 shadow-md mt-5 bg-white">
      <p>
