  ...
  return (
    <CalculatorLayout>
      <div className="p-4 max-w-md mx-auto rounded-lg shadow-md bg-white">
        <h1 className="text-2xl font-bold mb-4">Exponent Calculator
        <button
        ...
        <div className="mb-4">
          <label className="block mb-1">Exponent</label>
          <input
            type="number"
            placeholder="e.g. 3"
            className="w-full p-2 border rounded"
      ...
      <div className="p-4 mt-8 max-w-md mx-auto rounded-lg shadow-md bg-white">
      <p>
